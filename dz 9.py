...
class TicTacToeBoard:
    ...
    player = 2
    per = ''
    r21 = '-'  # r - это клетка. Первая цифра равна ряду (начинаются с 2)
    r22 = '-'  # вторая цифра равна клетке, то есть r21 == будет равна:
    r23 = '-'  # первой клетке в первом ряду
    r31 = '-'
    r32 = '-'
    r33 = '-'
    r41 = '-'
    ...
    def get_field(self):  # получение поля (список списков)
